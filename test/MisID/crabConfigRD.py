...
config.Data.lumiMask = 'MuonMisID/JetHT_2015D/crab_20170225_122050/results/notFinishedLumis.json'
...
config.Data.outLFNDirBase = '/store/user/jhgoh/MuonMisID/20170225_1/JetHT_2015D'
